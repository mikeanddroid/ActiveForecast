...
public class TestClassThree extends CoreFragment {

    private static final String TAG = TestClassThree.class.getSimpleName();
    private FragmentTransactionHandler fragmentTransactionHandler;

    public static TestClassThree getInstance() {
    ...
    public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle) {
        View rootView = layoutinflater.inflate(R.layout.testclasslayoutthree, viewgroup, false);
        try {
