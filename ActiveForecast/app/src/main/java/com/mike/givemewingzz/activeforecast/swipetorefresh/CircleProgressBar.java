...
public class CircleProgressBar extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mProgressColor = a.getColor(
                R.styleable.CircleProgressBar_mlpb_progress_color, getResources().getColor(R.color.ttdPrimaryColor));
        ...
        mProgressDrawable = new MaterialProgressDrawable(mColors, getContext(), this);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (getBackground() == null && mCircleBackgroundEnabled) {
            ...
            if (mBgCircle == null && elevationSupported()) {
    ...
    public void setVisibility(int visibility) {
        ...
        if (mProgressDrawable != null) {
            ...
            mProgressDrawable.setVisible(visibility == VISIBLE, true);
        }
    }
