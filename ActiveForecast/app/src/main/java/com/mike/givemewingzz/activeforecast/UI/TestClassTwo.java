...
public class TestClassTwo extends CoreFragment {

    private static final String TAG = TestClassTwo.class.getSimpleName();
    private FragmentTransactionHandler fragmentTransactionHandler;

    public TestClassTwo() {
    }

    public static TestClassTwo getInstance() {
    ...
    public View onCreateView(LayoutInflater layoutinflater, ViewGroup viewgroup, Bundle bundle) {
        View rootView = layoutinflater.inflate(R.layout.testclasslayouttwo, viewgroup, false);
        try {
